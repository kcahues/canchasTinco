...
if($jsonObj->request_type == 'addEvent'){
    ...
    if(!empty($eventTitle)){
        ...
        if($insert){
            ...
            echo json_encode(['error' => 'Fallo la creación de la reservación!']);
        }
    }
    ...
    if(!empty($eventTitle)){
        ...
        if($update){
            ...
            echo json_encode(['error' => 'Fallo la actualización!']);
        }
    }
    ...
    if($delete){
        ...
        echo json_encode(['error' => 'Error al intentar borrar!']);
    }
}