...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["idTipoAnticipo"])) {
    $idTipoAnticipo = $_POST["idTipoAnticipo"];
    ...
    $consulta = "DELETE FROM tipoanticipo WHERE idTipoAnticipo = ?";
    $stmt = $conexion->prepare($consulta);
    $stmt->bind_param("i", $idTipoAnticipo);
