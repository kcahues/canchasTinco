...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["idEstadoReserva"])) {
    $idEstadoReserva = $_POST["idEstadoReserva"];
    ...
    $consulta = "DELETE FROM estadoreserva WHERE idEstadoReserva = ?";
    $stmt = $conexion->prepare($consulta);
    $stmt->bind_param("i", $idEstadoReserva);
